    ...
    <div className="app">
      ...
      <main className="layout">
        <section className="main-panel">
          ...
          {tab === "campaign" && (
            <Panel title="Campaign" sub="Move chapter by chapter toward controlling the city.">
              <div className="card-grid">
                {campaign.map((chapter) => (
                  <ArtCard key={chapter.id} title={chapter.title} image={chapter.image} tag="Chapter" desc={chapter.desc}>
